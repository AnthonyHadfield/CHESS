...
class CWNetwork:
    ...
    def data_sets(self):
        ...
        self.datachess64W1 = np.load('C:/Users/user/PycharmProjects/CHESS/CHESSWORLD_DNNW5/W641_update.npy')
        self.datachess64W2 = np.load('C:/Users/user/PycharmProjects/CHESS/CHESSWORLD_DNNW5/W642_update.npy')
        self.datachess64W3 = np.load('C:/Users/user/PycharmProjects/CHESS/CHESSWORLD_DNNW5/W643_update.npy')
        self.datachess64W4 = np.load('C:/Users/user/PycharmProjects/CHESS/CHESSWORLD_DNNW5/W644_update.npy')
        self.datachess64W5 = np.load('C:/Users/user/PycharmProjects/CHESS/CHESSWORLD_DNNW5/W645_update.npy')
    ...
    def train(self):
        ...
        for i in range(2, epoch):
            ...
            if best_J > J:
                best_J = J
                np.save('C:/Users/user/PycharmProjects/CHESS/CHESSWORLD_DNNW5/W641_update', self.datachess64W1)
                np.save('C:/Users/user/PycharmProjects/CHESS/CHESSWORLD_DNNW5/W642_update', self.datachess64W2)
                np.save('C:/Users/user/PycharmProjects/CHESS/CHESSWORLD_DNNW5/W643_update', self.datachess64W3)
                np.save('C:/Users/user/PycharmProjects/CHESS/CHESSWORLD_DNNW5/W644_update', self.datachess64W4)
                np.save('C:/Users/user/PycharmProjects/CHESS/CHESSWORLD_DNNW5/W645_update', self.datachess64W5)
                np.save('C:/Users/user/PycharmProjects/CHESS/CHESSWORLD_DNNW5/best_J', best_J)
