...
class ChessWorld:
    ...
    def __init__(self):
        ...
        self.img_rook1_b = (); self.img_knight1_b = (); self.img_bishop1_b = (); self.img_queen_b = ();
        self.img_king_b = (); self.img_bishop2_b = (); self.img_knight2_b = (); self.img_rook2_b = ();
        self.img_pawn1_b = (); self.img_pawn2_b = (); self.img_pawn3_b = (); self.img_pawn4_b = ();
        self.img_pawn5_b = (); self.img_pawn6_b = (); self.img_pawn7_b = (); self.img_pawn8_b = ();
        self.img_rook1_w = () ; self.img_knight1_w = (); self.img_bishop1_w = (); self.img_queen_w = ()
        self.img_king_w = (); self.img_bishop2_w = (); self.img_knight2_w = (); self.img_rook2_w = ()
        self.img_pawn1_w = (); self.img_pawn2_w = (); self.img_pawn3_w = (); self.img_pawn4_w = ();
        self.img_pawn5_w = (); self.img_pawn6_w = (); self.img_pawn7_w = (); self.img_pawn8_w = ()
    ...
    def board(self):
        ...
        self.frame.create_rectangle(20, 17 + y1, 110, 105 + y1, fill='yellow3')
        # self.frame.create_rectangle(20+x1, 17+y1, 110+x1, 105+y1, fill='light yellow')
        self.frame.create_rectangle(20 + x1, 17 + y1, 110 + x1, 105 + y1, fill='yellow2')
