...
class ChessWorld:
    ...
    def white_pawn(self, i, j):
        ...
        if self.i_white_index == 6:
            ...
            self.potential_white_board_vector = [(self.mp[5][self.white_choice]), (self.mp[4][self.white_choice])]
            ...
            elif self.potential_white_board_vector[0] != '   ':
                print('')
                print('GET NEW MOVE')
                print('')
            ...
            """Pawns make second and beyond moves"""
        else:
            """Move index"""
            self.index = [[-1, -1], [-1, 0], [-1, 1]]
            """Add to original position index"""
            for x in range(0, 3):
                self.index[x][0] = self.index[x][0] + i
                self.index[x][1] = self.index[x][1] + j
            """remove off board indexes"""
            """REMOVE LEFT"""
            ...
            if len(self.potential_white_board_vector) == 2 and self.j_white_index == 7:
                ...
                if self.white_board_vector == []:
                    print('GET NEW WHITE MOVE')
                    self.white_piece_vector()
            """Moves beyond the 1st pawn move check each horizontal vector space """
            if len(self.potential_white_board_vector) == 3:
                ...
                """If no available moves GET NEW MOVE """
                if self.white_board_vector == []:
                    self.white_piece_vector()
        """Same as white"""
    ...
    def black_pawn(self, i, j):
        ...
        if self.i_black_index == 1:
            ...
            self.potential_black_board_vector = [(self.mp[2][self.black_choice]), (self.mp[3][self.black_choice])]
            ...
            elif self.potential_black_board_vector[0] != '   ':
    ...
    def white_piece_vector(self):
        ...
        while True:
            if self.start_white_pieces[self.white_choice] == '   ':
                self.white_choice = np.random.randint(0, len(self.start_white_pieces))
            if self.start_white_pieces[self.white_choice] != '   ':
                break
        for i in range(0, 8):
    ...
    def black_piece_vector(self):
        ...
        print('CHOICE', self.start_black_pieces)
        while True:
            if self.start_black_pieces[self.black_choice] == '   ':
                self.black_choice = np.random.randint(0, len(self.start_black_pieces))
            if self.start_black_pieces[self.black_choice] != '   ':
                break
        for i in range(0, 8):
    ...
    def white_board_label(self):
        ...
        if self.start_white_pieces[self.white_choice] == 'Pw1':
            ...
            self.agent = Ktw1
            print('MOVE Ktw1')
        elif self.start_white_pieces[self.white_choice] == 'Qw1':
            Qw1 = self.Qw1
            self.agent = Qw1
            print('MOVE Qw1')
        elif self.start_white_pieces[self.white_choice] == 'Qw2':
            Qw2 = self.Qw2
            self.agent = Qw2
            print('MOVE Qw2')
        elif self.start_white_pieces[self.white_choice] == 'Qw3':
            Qw3 = self.Qw3
            self.agent = Qw3
            print('MOVE Qw3')
        elif self.start_white_pieces[self.white_choice] == 'Qw4':
            Qw4 = self.Qw4
            self.agent = Qw4
            print('MOVE Qw4')
        elif self.start_white_pieces[self.white_choice] == 'Qw5':
            Qw5 = self.Qw5
            self.agent = Qw5
            print('MOVE Qw5')
    ...
    def black_board_label(self):
        ...
        if self.start_black_pieces[self.black_choice] == 'Pb1':
            ...
            self.agent = Bb1
            print('MOVE Bb1')
        elif self.start_black_pieces[self.black_choice] == 'Qb1':
            Qb1 = self.Qb1
            self.agent = Qb1
            print('MOVE Qb1')
        elif self.start_black_pieces[self.black_choice] == 'Qb2':
            Qb2 = self.Qb2
            self.agent = Qb2
            print('MOVE Qb2')
        elif self.start_black_pieces[self.black_choice] == 'Qb3':
            Qb3 = self.Qb3
            self.agent = Qb3
            print('MOVE Qb3')
        elif self.start_black_pieces[self.black_choice] == 'Qb4':
            Qb4 = self.Qb4
            self.agent = Qb4
            print('MOVE Qb4')
        elif self.start_black_pieces[self.black_choice] == 'Qb5':
            Qb5 = self.Qb5
            self.agent = Qb5
            print('MOVE Qb5')
    ...
    def move_random_piece(self):
        ...
        for z in range(1, 10):
            ...
            print('i =', z)
            self.white_piece_vector()
            print('NEXT MOVE identify', self.start_white_pieces[self.white_choice])
            self.white_board_label()
            print('AGENT', self.agent)
            """select random move"""
            # self.move = ()
            ...
            for m in range(0, 8):
                for n in range(0, 8):
                    if self.bc[m][n] == self.random_piece_board_coords:
                        ...
                        print(self.mp)
                        print('')
            print('CURRENT INDEX1', self.i_white_index)
            ...
            """MOVE piece"""
            self.random_piece_board_coords = self.black_move_vector[self.move]
            selection = self.random_piece_board_coords
            """define np move array"""
            ...
            for m in range(0, 8):
                for n in range(0, 8):
                    if self.bc[m][n] == self.random_piece_board_coords:
                        ...
                        print(self.mp)
                        print('')
            print('CURRENT INDEX2', self.i_black_index)
