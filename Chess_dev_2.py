...
class ChessWorld:
    ...
    def __init__(self):
        ...
        self.Pw5 = (); self.Pw6 = (); self.Pw7 = (); self.Pw8 = (); self.Pw1 = (); self.data = ()
        ...
        self.np = (); choice = (); zero_coord = (); random_piece = (); self.ip = []
        ...
        self.board_pieces = []; self.move_vector = []; self.white_pawns = []; self.black_pawns = []
        self.piece = ()
...
#        self.start_white_pieces = ['Pw1', 'Pw2', 'Pw3', 'Pw4', 'Pw5', 'Pw6', 'Pw7', 'Pw8', 'Rw1', 'Ktw1', 'Bw1', 'Qw',
 #                                  'Kw', 'Bw2', 'Ktw2', 'Rw2']
    ...
    def select_random_move(self):
        ...
        print('PIECE1', self.bp[self.i_index][self.j_index])

        #self.piece = self.bp[self.i_index][self.j_index]
    ...
    def move_random_piece(self):
        ...
        if self.random_piece == 'Ktw1':
            if self.i_index == 7 and self.j_index == 1:
                ...
                print('POTENTIAL coords', potential_coords_vector)
                print('POTENTIAL board', potential_board_vector)
                if potential_board_vector[0] == '   ':
                    self.move_vector.append(self.bc[5][self.j_index -1])
                if potential_board_vector[1] == '   ':
                    self.move_vector.append(self.bc[5][self.j_index +1])
                    print('')
                    print('POSSIBLE Ktw1 MOVES VECTOR', self.move_vector)
            ...
            if self.i_index == 7 and self.j_index == 6:
                ...
                if potential_board_vector[1] == '   ':
                    self.move_vector.append(self.bc[5][self.j_index + 1])
                    print('')
                    print('POSSIBLE MOVES VECTOR', self.move_vector)
        ...
        print('MOVE', move)
        print('')
        print('RANDOM MOVE coords', self.move_vector[move] )
        """MOVE piece"""
        ...
        print('PIECE', self.bp[self.i_index][self.j_index])
        ...
        print('self random piece', self.random_piece)
